 ...
 *
 */
package com.eros.soundtrack.services;
...
public class BackgroundAudioService extends Service implements MediaPlayer.OnCompletionListener,
    ...
    private Track videoItem;

    private boolean isStarting = false;
    private int currentSongIndex = 0;

    private ArrayList<Track> youTubeVideos;
    ...
    private void handleMedia(Intent intent) {
        ...
        switch (intentMediaType) {
            ...
            case YOUTUBE_MEDIA_TYPE_VIDEO:
                ...
                videoItem = (Track) intent.getSerializableExtra(Config.YOUTUBE_TYPE_VIDEO);
                if (videoItem.getYoutubeId() != null) {
                    playVideo();
                }
                break;
            case YOUTUBE_MEDIA_TYPE_PLAYLIST: //new playlist playback request
                mediaType = ItemType.YOUTUBE_MEDIA_TYPE_PLAYLIST;
                youTubeVideos = (ArrayList<Track>) intent.getSerializableExtra(Config.YOUTUBE_TYPE_PLAYLIST);
...
//    };
    ...
    private void extractUrlAndPlay() {
        String youtubeLink = Config.YOUTUBE_BASE_URL + videoItem.getYoutubeId();
        deviceBandwidthSampler.startSampling();
        Log.d(TAG, "extractUrlAndPlay: Url"+ youtubeLink);
